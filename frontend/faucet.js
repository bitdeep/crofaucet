$(document).ready(function() {
	...
	//////////////////////////////////////////////////////////////////////////////
	var rpcURL = "https://evm-cronos.crypto.org";
	var networkID = 25;
	var minGasPrice = 0;
	//////////////////////////////////////////////////////////////////////////////
	...
	var faucet_address = '0xfEE2E07E638f241D8aC44C7b92bBc08D13530621';
	//////////////////////////////////////////////////////////////////////////////
	...
	function checkFaucet() {
		...
		contract_faucet.tokenAmount(function(err, result) {
			if(!err) {
				tokenAmount = result;
				$("#requestButton").text("Request " + web3.fromWei(result, 'ether') + " Tokens");
			}
		});
	...
	function getTokens() {
		...
		web3.eth.getTransactionCount(account, function(errNonce, nonce) {
			if(!errNonce) {
				contract_faucet.cro({value: 0, gas: 200000, gasPrice: minGasPrice, from: account, nonce: nonce}, function(errCall, result) {
					if(!errCall) {
